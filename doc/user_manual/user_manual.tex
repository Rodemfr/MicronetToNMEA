...
Micronet devices cannot legally exceed a handful of milliwatts of transmit power. As a consequence the reception range will hardly exceed 10-15m. It is important not to put metal objects or panels between your various devices. This would dramatically reduce reception range of MicronetToNMEA.
...
It is generally considered not to be a good idea to use wireless electronics when you have a carbon boat or carbon sails. Fiberglass doesn't attenuates the signal (only a little), so it is safe to attach your device inside a cabin in a GRP boat.
...
Also, metal must be avoided. It deviates magnetic field. The bigger the piece of metal is the farthest you should put your device. In a boat you should avoid the keel, batteries and the inboard engine.
