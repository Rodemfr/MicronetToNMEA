...
The quality of the antenna is critical to maximize RF performance and operational range. Antennas provided with low cost breakout boards are often designed to be small at the cost of RF performance. An easy way to get a good quality antenna is to use a simple electrical wire with the adequat length : 345mm for 869MHz or 327mm for 915MHz. With such an antenna you can reach an operating range close to original Tacktick devices.
