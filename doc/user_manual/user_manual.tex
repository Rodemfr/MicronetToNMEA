...
\begin{table}[h]
	\begin{tabular}{|l|p{10cm}|}
		...
		\hline
		VOLTAGE\_SOURCE\_LINK & Defines where voltage data is coming from (related to XDG sentence). See Section {\ref{supportednmeasentences}} for more details on possible values.\\
		\hline
