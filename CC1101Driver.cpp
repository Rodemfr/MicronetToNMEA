...
{ 0x12, 0x0D, 0x1C, 0x34, 0x51, 0x85, 0xCB, 0xC2, }; //300 - 348
uint8_t PA_TABLE_433[8]
{ 0x12, 0x0E, 0x1D, 0x34, 0x60, 0x84, 0xC8, 0xC0, }; //387 - 464
//                        -30  -20  -15  -10  -6    0    5    7    10   12
uint8_t PA_TABLE_868[10]
{ 0x03, 0x17, 0x1D, 0x26, 0x37, 0x50, 0x86, 0xCD, 0xC5, 0xC0, };  //779 - 899.99
//                        -30  -20  -15  -10  -6    0    5    7    10   11
uint8_t PA_TABLE_915[10]
{ 0x03, 0x0E, 0x1E, 0x27, 0x38, 0x8E, 0x84, 0xCC, 0xC3, 0xC0, };  //900 - 928
/****************************************************************
 ...
 *OUTPUT       :none
 ****************************************************************/
void CC1101Driver::SpiStart(void)
{
 ...
 *OUTPUT       : none
 ****************************************************************/
void CC1101Driver::GDO_Set(void)
{
	pinMode(GDO0, INPUT);
	pinMode(GDO2, OUTPUT);
}
 ...
 *OUTPUT       :none
 ****************************************************************/
byte CC1101Driver::getMode(void)
{
	return trxstate;
}
 ...
 *OUTPUT       :none
 ****************************************************************/
void CC1101Driver::SetTx(float mhz)
{
	SpiStrobe(CC1101_SIDLE);
	setMHZ(mhz);
	SpiStrobe(CC1101_STX);        //start send
 ...
 *OUTPUT       :none
 ****************************************************************/
void CC1101Driver::SetRx(float mhz)
{
	SpiStrobe(CC1101_SIDLE);
	setMHZ(mhz);
	SpiStrobe(CC1101_SRX);        //start receive
 ...
 *OUTPUT       :none
 ****************************************************************/
void CC1101Driver::setSres(void)
{
 ...
 *OUTPUT       :none
 ****************************************************************/
void CC1101Driver::goSleep(void)
{
	trxstate = 0;
 ...
 *OUTPUT       :none
 ****************************************************************/
void CC1101Driver::SendData(char *txchar)
{
 ...
 *OUTPUT       :none
 ****************************************************************/
void CC1101Driver::SendData(byte *txBuffer, byte size)
{
 ...
 *OUTPUT       :none
 ****************************************************************/
void CC1101Driver::SendData(char *txchar, int t)
{
	int len = strlen(txchar);
	byte chartobyte[len];
	for (int i = 0; i < len; i++)
 ...
 *OUTPUT       :none
 ****************************************************************/
void CC1101Driver::SendData(byte *txBuffer, byte size, int t)
{
	SpiWriteReg(CC1101_TXFIFO, size);
	SpiWriteBurstReg(CC1101_TXFIFO, txBuffer, size);      //write data to send
	SpiStrobe(CC1101_SIDLE);
 ...
 *OUTPUT       :none
 ****************************************************************/
bool CC1101Driver::CheckCRC(void)
{
 ...
 ****************************************************************/
bool CC1101Driver::CheckRxFifo(int t)
{
	if (trxstate != 2)
	{
		SetRx();
 ...
 *OUTPUT       :flag: 0 no data; 1 receive data
 ****************************************************************/
byte CC1101Driver::CheckReceiveFlag(void)
{
	if (trxstate != 2)
	{
		SetRx();
 ...
 ****************************************************************/
byte CC1101Driver::ReceiveData(byte *rxBuffer)
{
	byte size;
	byte status[2];
	...
	{
		SpiReadBurstReg(CC1101_RXFIFO, rxBuffer, size & BYTES_IN_RXFIFO);
